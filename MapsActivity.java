...
import com.medsupport.med.databinding.ActivityMapsBinding;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng dhaka = new LatLng(23.805704701548578, 90.3815494093119);
        mMap.addMarker(new MarkerOptions().position(dhaka).title("Marker in Dhaka"));
        mMap.moveCamera(CameraUpdateFactory.newLatLng(dhaka));
        mMap.animateCamera(CameraUpdateFactory.newLatLngZoom(dhaka,  16f));
    }
}